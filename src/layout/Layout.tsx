  ...
  return (
    <>
      ...
      <FlexContainer className="min-h-screen">
        <ContentContainer className="hidden transition duration-500 shadow-md navbar sm:block dark:bg-gray-800">
          <Header />
        </ContentContainer>
        <ContentContainer className="flex-grow pb-4">
          {children}
        </ContentContainer>
        <ContentContainer className="fixed bottom-0 w-full shadow navbar sm:hidden">
          <Header />
        </ContentContainer>
      </FlexContainer>
    </>
