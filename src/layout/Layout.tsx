  ...
  return (
    <>
      ...
      <FlexContainer className="min-h-screen">
        <ContentContainer className="hidden transition duration-500 border-b dark:border-gray-800 navbar sm:block">
          <Header />
        </ContentContainer>
        <ContentContainer className="flex-grow pb-4">
          {children}
        </ContentContainer>
        <ContentContainer className="fixed bottom-0 w-full transition duration-500 border-t dark:border-gray-800 navbar sm:hidden">
          <Header />
        </ContentContainer>
      </FlexContainer>
    </>
